...
**示例1 ：** 以曝光时间 1/500s 拍摄——主体清晰，但手部产生模糊：
...
### 🎯 第三要点：RAW连拍
建议设置相机为RAW格式连拍模式，因为**拍摄足够多的前期照片是保证出图的最行之有效的解决方案**。
有足够多的前期积累，才能选出"光线、姿势、表情" 通通在线的照片。
关于多拍的实践细节可参考本文后面的" 干他个一万张💥 " 部分。
...
如果祭出点测光依然无力回天，那就弃疗、发力后期修图吧 <img src="emoji/haha.avif"  style="max-height: 1.5rem; display: inline-block;">。
...
> 如果你真的考虑拍摄上万张照片，注意以下两个细节:

**1. 存储卡容量** 

选择至少 1TB 空间的CF-A存储卡，
测试 512GB 存储卡在索尼A1机型上最高可拍摄7126张 五千万像素的无损压缩RAW ，因此可估算1万张照片需 718GB 存储空间、而1TB 约支持拍摄超过14000张。


**2. 避免覆盖重名照片**

索尼照片文件命名规则为 "DSC+四位数字编号"，文件的最大编号值为"9999"，随后文件编号将产生重复。
为避免名称冲突，相机会自动将照片分到不同的文件夹中（例如 100MSDCF、101MSDCF、102MSDCF），每个文件夹4000张。
如果后期打算将这些照片一股脑放入同一个文件夹，一定要注意避免发生文件覆盖！
...
1星的含义是留下照片但是**不会**拿来修图与返图——比如你打算为宝宝积攒"偷感姿势合集"以便日后给她一个惊喜；
2~4星则是对照片效果的评分。
